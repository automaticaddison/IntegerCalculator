...
Heading:		.ascii	"\nSimple Integer Calculator \n\n"
				.ascii	"Computer Organization, EN.605.204.81.FA17  \n"
				.asciiz	"Author: Addison Sears-Collins \n\n"	
Prompt:
	.asciiz	"\nPlease enter the expression (e.g. Total = 63 * 72): "
